  ...
  useEffect(() => {
    setTimeout(() => {
      ...
      if (inputContainer) {
        ...
        const inner = inputContainer.getElementsByClassName(
    ...
    <div>
      ...
      <div className=" wizard absolute w-full max-w-md h-16  overflow-hidden">
        ...
        >
          <img
            src={
              'https://raw.githubusercontent.com/mritunjayz/test-private/e78b4cc678b151eee498d3ff66c4f0678c288799/wizard_svg.svg'
            }
            alt="Animated SVG"
      ...
      <div
        className={`onboarding-info-card w-[360px] border-[1px] border-grey-500 border-solid rounded-xl shadow-xl transition-all duration-1000 ease-in-out overflow-hidden ${expandInfoContainer ? 'h-[370px]' : 'h-0'}`}
      >
        <div
          className={`flex flex-col items-center justify-center w-full transition-opacity duration-1000 ${expandInfoContainer ? 'opacity-100' : 'opacity-0'}`}
        >
          <div className="relative bg-white w-full max-w-lg rounded-lg overflow-hidden">
            <div className="relative w-full bg-white rounded-md mb-2">
              ...
              >
                <source
                  src="https://github.com/mritunjayz/test-private/raw/refs/heads/main/GetData_demo.mp4"
                  type="video/mp4"
                />
            ...
            <div className="relative overflow-hidden p-4 h-24 gap-2">
              ...
              >
                <h2 className="onboarding-info-header">
                  Get real time Onchain data
                </h2>
                <p className="onboarding-info-description">
                  Get realtime data from blockchain via 1 function Lorem ipsum
                  dolor sit amet💛
                </p>
              </div>
              ...
              >
                ...
                <p className="text-2xl mb-2">
                  Track transactions and monitor blockchain activity
                </p>
            ...
            <div className="flex justify-between items-center p-4">
              ...
              <div className="flex gap-4">
                {currentCard === 1 ? (
                  ...
                  <button onClick={prevCard} className="">
                    Back
                  </button>
                )}
