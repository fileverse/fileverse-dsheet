export default {
  ...
  functionlist: [
    ...
    },
    {
      ...
      p: [
        ...
        },
        {
          name: 'item1',
          detail:
            '[可選] - 數據透視錶中顯示的與您要檢索的欄位名稱1相對應的行或列的名稱。',
          example: '"east"',
          require: 'o',
          repeat: 'y',
          type: 'rangeall',
    ...
    },
    {
      ...
      t: 11,
      d:
        '如果第一個參數嚴格大於第二個，則返回TRUE；否則返回FALSE。相當於' >
        '運算子。',
      a:
        '如果第一個參數嚴格大於第二個，則返回TRUE；否則返回FALSE。相當於' >
        '運算子。',
    ...
    // DATA_CN_STOCK_CLOSE
    {
      ...
      p: [
        ...
        },
        {
          ...
          example: '0',
          detail:
            '選擇股票的除權複權類型，默認0[前複權]，1[原始價格]，2[後複權]',
          require: 'o',
          repeat: 'n',
          type: 'rangenumber',
        },
    ...
    // sparklines函数,线图
    {
      ...
      p: [
        ...
        // lineColor
        {
          ...
          example: '#2ec7c9',
          detail:
            '線圖的線條顏色，可以是否個範圍A1、色錶索引數值或者具體顏色值，設定為0或false則不顯示，支持regx、rgb、rgba等。默認#2ec7c9',
          require: 'o',
          repeat: 'n',
          type: 'rangeall',
        },
        ...
        // normalRangeMin和normalRangeMax设为相同的值,min、max、avg、median需要计算
        {
          ...
          example: 'avg',
          detail:
            '一條橫線，可以是min、max、avg、median、範圍或自定義數值，默認0無',
          require: 'o',
          repeat: 'n',
          type: 'rangeall',
        },
    ...
    // sparklines柱状图
    {
      ...
      p: [
        ...
        // barColor
        {
          ...
          example: '#fc5c5c',
          detail:
            '線圖的線條顏色，可以是否個範圍A1、色錶索引數值或者具體顏色值，設定為0或false則不顯示，支持regx、rgb、rgba等。默認#fc5c5c',
          require: 'o',
          repeat: 'n',
          type: 'rangeall',
        },
        // negBarColor
        {
          ...
          example: '#97b552',
          detail:
            '負向柱條顏色設定，代表負值的顏色，同柱條顏色配寘，默認#97b552',
          require: 'o',
          repeat: 'n',
          type: 'rangeall',
        },
        // chartRangeMax
        {
          ...
          example: '100',
          detail:
            '柱圖最大值，用於規範柱圖長度，默認為自動計算false、auto、null',
          require: 'o',
          repeat: 'n',
          type: 'rangeall',
        },
    ...
    // sparklines累积柱状图
    {
      ...
      p: [
        ...
        // chartRangeMax
        {
          ...
          example: '100',
          detail:
            '累積柱圖最大值，用於規範柱圖長度，默認為自動計算false、auto、null',
          require: 'o',
          repeat: 'n',
          type: 'rangeall',
        },
        // stackedBarColor
        {
          ...
          example: '#97b552',
          detail:
            '調色板可以單獨設定每個維度的柱條顏色，可設定為A1:A10等範圍，默認為#2ec7c9, #fc5c5c, #5ab1ef, #ffb980...',
          require: 'o',
          repeat: 'y',
          type: 'rangeall',
        },
    ...
    // sparklines离散图
    {
      ...
      p: [
        ...
        // thresholdValue
        {
          ...
          example: '1',
          detail:
            '離散圖柱形顏色的區分，例如:該值為0，則大於0為藍色，小於0為紅色，默認為0',
          require: 'o',
          repeat: 'n',
          type: 'rangeall',
        },
    ...
    // sparklines饼图
    {
      ...
      p: [
        ...
        // sliceColors
        {
          ...
          example: '#97b552',
          detail:
            '調色板可以設定切片的顏色，可設定為A1:A10等範圍，默認為#2ec7c9, #fc5c5c, #5ab1ef, #ffb980...',
          require: 'o',
          repeat: 'y',
          type: 'rangeall',
        },
    ...
    // sparklines子弹图
    {
      ...
      p: [
        ...
        // 对比值datax
        {
          ...
          example: '12',
          detail:
            '對比值，例如超額、最低、獲獎底線等，數值才能被有效計算，例如A1，100等。可以設定最多9個對比值',
          require: 'o',
          repeat: 'y',
          type: 'rangeall',
        },
    ...
    // 动态数组公式
    {
      ...
      p: [
        ...
        },
        {
          name: 'by_col',
          detail:
            '[可選] - 表示所需排序方向的邏輯值；按行排序為FALSE（）（默認），按列排序為TRUE（）。',
          example: 'TRUE()',
          require: 'o',
          repeat: 'n',
          type: 'rangeall',
    ...
    },
    {
      ...
      p: [
        ...
        },
        {
          name: 'if_empty',
          detail:
            '[可選] - 如果包含數組中的所有值都為空（filter不返回任何值），則返回的值。',
          example: '""',
          require: 'o',
          repeat: 'n',
          type: 'rangeall',
