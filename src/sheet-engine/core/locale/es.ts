export default {
  ...
  alternatingColors: {
    ...
    errorInfo:
      'No se puede realizar esta operación en varias áreas de selección, selecciona una sola área y vuelve a intentarlo',
  ...
  paint: {
    ...
    tipNotMulti:
      'No se puede realizar esta operación en un rango de selección múltiple',
  },
  format: {
  ...
  screenshot: {
    ...
    screenshotTipHasMerge:
      'Esta operación no se puede realizar en celdas combinadas',
    screenshotTipHasMulti:
      'Esta operación no se puede realizar en varios rangos de selección',
    ...
    rightclickTip:
      'Haz clic con el botón derecho en la imagen y selecciona "copiar"',
    successTip:
      'Con éxito (si falla el pegado, haz clic con el botón derecho en la imagen para "copiar imagen")',
  },
  splitText: {
    ...
    tipNoMulti:
      'No se puede realizar esta operación en varias áreas de selección, selecciona una única área y vuelve a intentarlo',
    tipNoMultiColumn:
      'Solo se puede convertir una columna de datos a la vez. El área seleccionado puede tener varias filas, pero no varias columnas. Vuelve a intentarlo después de seleccionar un solo rango de columnas',
  },
  imageText: {
  ...
  sheetconfig: {
    ...
    noMoreSheet:
      'El libro de trabajo contiene al menos una hoja de trabajo visual. Para eliminar la hoja de trabajo seleccionada, inserta una nueva hoja de trabajo o muestra una hoja de trabajo oculta',
  ...
  conditionformat: {
    ...
    conditionformat_duplicateValue_title:
      'Dar formato a celdas que contienen los siguientes tipos de valores',
    ...
    conditionValueCanOnly:
      'El valor de la condición solo puede ser un número o una sola celda',
    ruleTypeItem1:
      'Aplicar formato a todas las celdas según sus valores respectivos',
    ruleTypeItem2: 'Solo formatear celdas que contengan',
    ruleTypeItem2_title:
      'Solo para celdas que cumplan las siguientes condiciones',
    ...
    ruleTypeItem4:
      'Aplicar formato solo a los valores superiores o inferiores al promedio',
  ...
  dataVerification: {
    ...
    placeholder5:
      'Introduce el mensaje que se muestra cuando se selecciona la celda',
    ...
    prohibitInput:
      'Prohibir la entrada cuando los datos de entrada no son válidos',
    ...
    tooltipInfo2:
      'El contenido de la casilla de verificación no puede estar vacío',
    ...
    textlengthInteger:
      'La longitud del texto debe ser un entero mayor o igual a 0',
  },
  formula: {
    sum: 'Suma',
    average: 'Media',
    ...
    ifGenTipNotGenCondition:
      'No hay condiciones disponibles para la generación!',
  },
  formulaMore: {
    valueTitle: 'Valor',
    ...
    execfunctionSelfError:
      'La fórmula no puede hacer referencia a su propia celda',
    execfunctionSelfErrorResult:
      'La fórmula no puede hacer referencia a su propia celda, lo que dará lugar a resultados de cálculo inexactos',
  ...
  drag: {
    ...
    afectarPivot:
      '¡Este cambio no se puede realizar en la celda seleccionada porque afectará a la tabla dinámica!',
    noMulti:
      'No se puede realizar esta operación en varias áreas de selección, selecciona una sola área',
    noPaste:
      'No se puede pegar este contenido aquí, selecciona una celda en el área de pegado e intenta pegar nuevamente',
    noPartMerge:
      'No se puede realizar esta operación en celdas parcialmente fusionadas',

    inputCorrect: 'Introduce el valor correcto',
    notLessOne: 'El número de filas y columnas no puede ser inferior a 1',
    offsetColumnLessZero:
      '¡La columna de desplazamiento no puede ser negativa!',
  ...
  pivotTable: {
    ...
    errorNotAllowMulti:
      'No se puede realizar esta operación en varias áreas de selección, selecciona un solo rango y vuelve a intentarlo',
    ...
    errorNotAllowPivotData:
      '¡No se puede seleccionar la tabla dinámica como datos de origen!',
  ...
  protection: {
    ...
    enterHint:
      'La celda o el gráfico que estás intentando cambiar se encuentra en una hoja de trabajo protegida. Si quieres cambiarlo, desprotege la hoja de trabajo. Es posible que tengas que ingresar una contraseña',
    swichProtectionTip:
      'Protege la hoja y el contenido de las celdas bloqueadas',
    ...
    allowRangeAddTitleHintTitle:
      'Preguntar cuando hay una contraseña (opcional)',
    ...
    validationTips:
      'Hay que ingresar una contraseña para desbloquear la protección de la hoja de trabajo',
    validationInputHint: 'Introduce una contraseña',

    checkPasswordNullalert: 'Contraseña requerida!',
    checkPasswordWrongalert:
      '¡Contraseña incorrecta. Por favor, prueba de nuevo!',
    ...
    defaultSheetHintText:
      'La celda o el gráfico están en una hoja de trabajo protegida. Para realizar cambios, desprotege la hoja de trabajo. Es posible que tengas que ingresar una contraseña',
  },
  cellFormat: {
    ...
    hidden: 'Escondido',
    protectionTips:
      'Para bloquear celdas u ocultar fórmulas, protege la hoja de trabajo. En la barra de herramientas, haz clic en el botón Proteger hoja',
  ...
  websocket: {
    ...
    refresh:
      'Se produjo un error en la conexión de WebSocket, ¡actualice la página!',
    wait: 'Se produjo un error en la conexión de WebSocket, ¡tenga paciencia!',
    close: 'Conexión WebSocket cerrada',
    contact:
      'Ocurrió un error de comunicación con el servidor, actualice la página y vuelva a intentarlo; de lo contrario, comuníquese con el administrador.',
