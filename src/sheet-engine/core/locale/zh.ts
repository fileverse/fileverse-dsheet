    ...
    },
    {
      ...
      p: [
        ...
        },
        {
          name: 'cumulative',
          detail:
            'TRUE() 表示使用累积分布函数，FALSE() 则表示使用概率密度函数。',
          example: 'TRUE()',
          require: 'm',
          repeat: 'n',
          type: 'rangeall',
    ...
    // BIRTHDAY_BY_IDCARD
    {
      ...
      p: [
        ...
        },
        {
          ...
          example: '0',
          detail:
            '日期类型,默认0:[1900/01/01], 1:[1900-01-01], 2:[1900年1月1日]',
          require: 'o',
          repeat: 'n',
          type: 'rangeall',
        },
    ...
    // DATA_CN_STOCK_CLOSE
    {
      ...
      p: [
        ...
        },
        {
          ...
          example: '0',
          detail:
            '选择股票的除权复权类型，默认0[前复权], 1[原始价格], 2[后复权]',
          require: 'o',
          repeat: 'n',
          type: 'rangenumber',
        },
    ...
    // sparklines函数，线图
    {
      ...
      p: [
        ...
        // normalRangeMin和normalRangeMax设为相同的值，min、max、avg、median需要计算
        {
          ...
          example: 'avg',
          detail:
            '一条横线，可以是min、max、avg、median、范围或自定义数值，默认0无',
          require: 'o',
          repeat: 'n',
          type: 'rangeall',
        },
    ...
    // sparklines柱状图
    {
      ...
      p: [
        ...
        // negBarColor
        {
          ...
          example: '#97b552',
          detail:
            '负向柱条颜色设置，代表负值的颜色，同柱条颜色配置，默认#97b552',
          require: 'o',
          repeat: 'n',
          type: 'rangeall',
        },
        // chartRangeMax
        {
          ...
          example: '100',
          detail:
            '柱图最大值，用于规范柱图长度，默认为自动计算false、auto、null',
          require: 'o',
          repeat: 'n',
          type: 'rangeall',
        },
    ...
    // sparklines累积柱状图
    {
      ...
      p: [
        ...
        // chartRangeMax
        {
          ...
          example: '100',
          detail:
            '累积柱图最大值，用于规范柱图长度，默认为自动计算false、auto、null',
          require: 'o',
          repeat: 'n',
          type: 'rangeall',
        },
    ...
    // sparklines离散图
    {
      ...
      p: [
        ...
        // thresholdValue
        {
          ...
          example: '1',
          detail:
            '离散图柱形颜色的区分，例如：该值为0，则大于0为蓝色，小于0为红色，默认为0',
          require: 'o',
          repeat: 'n',
          type: 'rangeall',
        },
    ...
    // 动态数组公式
    {
      ...
      p: [
        ...
        },
        {
          name: 'by_col',
          detail:
            '[可选] - 表示所需排序方向的逻辑值；按行排序为FALSE()（默认），按列排序为TRUE()。',
          example: 'TRUE()',
          require: 'o',
          repeat: 'n',
          type: 'rangeall',
    ...
    },
    {
      ...
      p: [
        ...
        },
        {
          name: 'if_empty',
          detail:
            '[可选] - 如果包含数组中的所有值都为空(filter不返回任何值)，则返回的值。',
          example: '""',
          require: 'o',
          repeat: 'n',
          type: 'rangeall',
