...
export default {
  ...
  currencyDetail: [
    ...
    { name: 'RMB', pos: 'before', value: 'CN¥', geckoId: 'cny' },
    { name: 'GBP', pos: 'before', value: '￡', geckoId: 'gbp' },
    { name: 'HK', pos: 'before', value: 'K$', geckoId: 'hkd' },
    { name: 'JPY', pos: 'before', value: 'jp¥', geckoId: 'jpy' },
    { name: 'Australian Dollar', pos: 'before', value: 'AU$', geckoId: 'aud' },
    { name: 'Bangladeshi Taka', pos: 'before', value: '৳', geckoId: 'bdt' },
    { name: 'Bahraini Dinar', pos: 'before', value: 'NAR', geckoId: 'bhd' },
    ...
    { name: 'New Israeli Shekel', pos: 'before', value: 'N￡', geckoId: 'ils' },
    { name: 'Indian Rupee', pos: 'before', value: '₹', geckoId: 'inr' },
    { name: 'Soutth korean won', pos: 'before', value: '₩', geckoId: 'krw' },
    { name: 'Kuwaiti Dinar', pos: 'before', value: 'KW', geckoId: 'kwd' },
    { name: 'Sri Lanka Rupee', pos: 'before', value: 'L₹', geckoId: 'lkr' },
    { name: 'Myanmar Kyat', pos: 'before', value: 'K', geckoId: 'mmk' },
    { name: 'Mexican Peso', pos: 'before', value: 'PO$', geckoId: 'mxn' },
    { name: 'Malaysian Ringgit', pos: 'before', value: 'R', geckoId: 'myr' },
    { name: 'Nigerian Naira', pos: 'before', value: '₦', geckoId: 'ngn' },
    { name: 'Norwegian Krone', pos: 'after', value: '₦kr', geckoId: 'nok' },
    { name: 'New Zealand Dollar', pos: 'before', value: 'Z$', geckoId: 'nzd' },
    { name: 'Philippine Peso', pos: 'before', value: '₱', geckoId: 'php' },
    { name: 'Pakistan Rupee', pos: 'before', value: 'P₹', geckoId: 'pkr' },
    { name: 'Polish Zloty', pos: 'after', value: 'zł', geckoId: 'pln' },
    { name: 'Russian Ruble', pos: 'after', value: 'RU', geckoId: 'rub' },
    { name: 'Saudi Riyal', pos: 'before', value: 'Rial', geckoId: 'sar' },
    { name: 'Swedish Krona', pos: 'after', value: 'kr', geckoId: 'sek' },
    { name: 'Singapore Dollar', pos: 'before', value: 'P$', geckoId: 'sgd' },
    { name: 'Thai Baht', pos: 'before', value: '฿', geckoId: 'thb' },
    { name: 'Turkish Lira', pos: 'before', value: 'TL', geckoId: 'try' },
    { name: 'Ukrainian Hryvnia', pos: 'before', value: 'грн.', geckoId: 'uah' },
    { name: 'South African Rand', pos: 'before', value: 'ZAR', geckoId: 'zar' },
  ],
  ...
  findAndReplace: {
    ...
    searchMatchCountAria: '{current} of {total}',
    ...
    quickSearchCloseAria: 'Close quick search',
  ...
  conditionformat: {
    ...
    applyRange: 'Apply to',
    invalidRangeText: 'Enter a valid range (e.g. A1:B2, A1, or Sheet1!A1:C3)',
    ...
    pleaseEnterDateDdMmYyyy: 'Please enter a valid date (DD/MM/YYYY)',
    ...
    cfDatePreset_today: 'today',
    cfDatePreset_tomorrow: 'tomorrow',
    cfDatePreset_yesterday: 'yesterday',
    cfDatePreset_pastWeek: 'in the past week',
    cfDatePreset_pastMonth: 'in the past month',
    cfDatePreset_pastYear: 'in the past year',
    cfDatePreset_exact: 'exact date',
    ...
    all: 'All',
    yesterday: 'YTD',
    formatCellsIfRulesGroup_presenceText: 'Blanks and text',
    formatCellsIfRulesGroup_dates: 'Dates',
    formatCellsIfRulesGroup_numbers: 'Numbers',
    today: 'Today',
    tomorrow: 'Tomorrow',
    lastWeek: 'Last week',
    thisWeek: 'This week',
