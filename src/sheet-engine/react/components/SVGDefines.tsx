...
const SVGDefines: React.FC<{ currency: string }> = ({ currency }) => (
  ...
  >
    <defs>
      ...
      <symbol fill="none" viewBox="0 0 16 16" id="delete-flv">
      ...
      <symbol fill="none" viewBox="0 0 16 16" id="hide-flv">
        <svg viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g clipPath="url(#clip0_2908_227339)">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
      ...
      <symbol fill="none" viewBox="0 0 16 16" id="resize-flv">
        <svg viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
      ...
      <symbol fill="none" viewBox="0 0 16 16" id="split-flv">
        <svg viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
        ...
        <g transform="translate(2, 1.3)">
          <g transform="scale(0.9)">
            <svg
              ...
              transform="scale(1.2)"
            >
              <g clipPath="url(#clip0_1019_159235)">
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
      ...
      >
        <g transform="translate(1, 2)">
          <g transform="scale(0.9)" clipPath="url(#clip0_format_painter)">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
      ...
      <symbol viewBox="0 0 1024 1024" fill="currentColor" id="copy">
        <path
      ...
      <symbol viewBox="0 0 1024 1024" fill="currentColor" id="pencil">
        <path
      ...
      <symbol fill="currentColor" id="unlink" viewBox="0 0 1024 1024">
        <path
      ...
      <symbol viewBox="0 0 1024 1024" id="filter-fill">
        <path
      ...
      <symbol id="headDownArrow" viewBox="0 0 14 14">
        <rect width="14" height="14" rx="4" fill="black" fillOpacity="0.1" />
        <path
      ...
      <symbol id="copy-flv" viewBox="0 0 24 24">
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <g clipPath="url(#clip0_1714_87221)">
            <path
      ...
      <symbol id="cut-flv" viewBox="0 0 24 24">
        <svg viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            fillRule="evenodd"
            clipRule="evenodd"
      ...
      <symbol id="asc-sort-flv" viewBox="0 0 24 24">
        <svg viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            fillRule="evenodd"
            clipRule="evenodd"
      ...
      <symbol id="des-sort-flv" viewBox="0 0 24 24">
        <svg viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            fillRule="evenodd"
            clipRule="evenodd"
      ...
      <symbol id="freeze-flv" viewBox="0 0 24 24">
        <svg
          width="18"
          height="16"
          viewBox="0 0 18 16"
      ...
      <symbol id="dune-logo" viewBox="0 0 18 16" fill="none">
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <g clipPath="url(#clip0_80_246690)">
            <path
      ...
      <symbol id="circle-alert" viewBox="0 0 14 14" fill="none">
        <svg
          width="14"
          height="14"
          viewBox="0 0 14 14"
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <g clipPath="url(#clip0_138_127604)">
            <path
      ...
      <symbol
        ...
        fill="none"
      >
        <g clipPath="url(#clip0_568_119011)">
          <path
